...
import com.meanwhile.flowcodelab.stage3.ThreeEndViewModel
import com.meanwhile.flowcodelab.stage3.ThreeStartViewModel
...
class StageThreeSolutionTest: BehaviorSpec( {

    Dispatchers.setMain(UnconfinedTestDispatcher())
    val fakeUseCase = FakeSharedFlowGetDaysUntilWeekendUseCase()

    Given("a ThreeEndViewModel"){
        val tested = ThreeEndViewModel(fakeUseCase)
    ...
    Given ("A ThreeEndViewModel with Flow based use case") {
        val useCase = FakeSharedFlowGetDaysUntilWeekendUseCase()
        val tested = ThreeEndViewModel(useCase)
        ...
        When("onRefresh is called") {
            ...
            Then("uiState third emitted is loading and -1 days") {
                ...
                assertEquals(99, ret[2].daysUntilWeekend)
            }
