...
class StageThreeTest: BehaviorSpec( {

    Dispatchers.setMain(UnconfinedTestDispatcher())
    val fakeUseCase = FakeSharedFlowGetDaysUntilWeekendUseCase()

    Given("a ThreeStartViewModel"){
        val tested = ThreeStartViewModel(fakeUseCase)
    ...
    Given ("A ThreeStartViewModel with Flow based use case") {
        val useCase = FakeSharedFlowGetDaysUntilWeekendUseCase()
        val tested = ThreeStartViewModel(useCase)
